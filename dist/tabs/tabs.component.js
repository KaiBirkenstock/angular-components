...
var TabsComponent = /** @class */ (function () {
    ...
    TabsComponent.decorators = [
        { type: Component, args: [{
                    ...
                    styles: ["\n    :host{display:block;margin:auto;overflow:hidden}:host div.tab-collection{overflow:hidden;border-bottom:1px solid #eaecee;background-color:transparent}:host:after{clear:both}:host tab{float:left;position:relative;display:block;padding:.5rem 1rem;cursor:pointer;font-weight:600;padding-top:12px;padding-bottom:12px;border:1px solid transparent;margin-bottom:-1px}:host tab.active,:host tab:hover{box-shadow:inset 0 -2px #1E1934;position:relative;background-color:transparent;border-bottom:medium none}:host tab.active{color:#575757;cursor:default}:host tab:hover{color:#1E1934;cursor:pointer}:host tab-content{clear:both;display:block}:host tab-content>div{background-color:#fff;border-radius:0;padding:10px;display:none}:host tab-content>div.visible{display:block}:host tab-content tab{color:#337ab7;background-color:#fff;padding:10px 15px !important;border:none !important;margin-bottom:0 !important}:host tab-content tab.active{color:#fff;background-color:#337ab7}:host tab-content tab tab-content>div{border:medium none}\n  "]
                },] },
    ];
    /** @nocollapse */
